  ...
  if (parsingSysex) {
    ...
    if( (waitForData==0) && executeMultiByteCommand ) { // got the whole message
      ...
      case REPORT_DIGITAL:
        ...
        break;
      case SRF_04_MESSAGE:
	if(currentSRF04Callback) 
	  (*currentSRF04Callback)(storedInputData[1], storedInputData[0]);
      }
...
void FirmataClass::sendDistance(int value) {
  FirmataSerial->write(SRF_04_MESSAGE);
  sendValueAsTwo7bitBytes(value);
}
...
void FirmataClass::attach(byte command, callbackFunction newFunction)
{
  ...
  case SRF_04_MESSAGE: currentSRF04Callback = newFunction; break;
  }
}
